    ...
    if request.method == 'POST':
        ...
        if request.POST.get('bid'):
            ...
            if len(request.POST.get('bid')) < 10:
                ...
                # Get the highest bid
                #To calculate summary values over the objects that belong to this QuerySet->Bids.objects.filter(item_id=itemId)
                #This is done by appending an aggregate() clause onto the QuerySet
